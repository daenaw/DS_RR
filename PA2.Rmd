---
title: "Analysis of severe weather events across US with impact to population and economy"
output: 
  html_document:
    keep_md: true
---
...
1. Here's the script to download and extract the storm dataset
...
1. Here's a sample of the weather events dataset
...
1. Which types of events are most harmful to population health? We will based it on the fatality and injury count.
...
From both graphs, Tornado ranks the highest in terms of fatality and injury count.


2. Which types of events have the greatest economic consequences?

```{r}
#update for property damage
txn$PROPEXP[txn$PROPDMGEXP == "K"] <- 1000
txn$PROPEXP[txn$PROPDMGEXP == "M"] <- 1e+06
txn$PROPEXP[txn$PROPDMGEXP == ""] <- 1
txn$PROPEXP[txn$PROPDMGEXP == "B"] <- 1e+09
txn$PROPEXP[txn$PROPDMGEXP == "m"] <- 1e+06
txn$PROPEXP[txn$PROPDMGEXP == "0"] <- 1
...
txn$CROPEXP[txn$CROPDMGEXP == "0"] <- 1
txn$CROPEXP[txn$CROPDMGEXP == "k"] <- 1000
txn$CROPEXP[txn$CROPDMGEXP == "2"] <- 100
txn$CROPEXP[txn$CROPDMGEXP == ""] <- 1
txn$CROPEXP[txn$CROPDMGEXP == "?"] <- 0
